...
namespace PDF_Resume_Creator
{
    ...
    
    {
        ...
        static SKColor DARK_GREEN = new(29, 130, 76);
        ...
        private void renderSectionContent(string dateLine, string title, string subtitle, string description)
        {
            ...
            var rsSection = new RichString()
                ...
                .Add(title.ToUpper() + ", ", fontWeight: BOLD_WEIGHT, textColor: DARK_GREEN)
        ...
        private void renderBulletList(List<string> list)
        {
            ...
            foreach (var item in list)
            {
                ...
                currentPageCanvas.DrawCircle(currentPaintPos.X + bulletRadius + 6F, currentPaintPos.Y + bulletRadius, bulletRadius, new SKPaint { Color = DARK_GREEN });
